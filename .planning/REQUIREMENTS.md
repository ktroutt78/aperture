...
- [ ] **SCAF-05**: Backend authenticates against Tableau Cloud REST API with PAT and returns a valid `X-Tableau-Auth` token
- [ ] **SCAF-06**: Backend caches the Tableau token and auto-refreshes on any 401 from a downstream Tableau API
